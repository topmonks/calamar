...
export const polkadotJsNetworkParachainIds: Record<string, number> = {
	"equilibrium": 2011,
};
...
// TODO import chain colors from @polkadot/apps-config when version 0.124.2 is released which includes colors into endpoints configs
// colors are copied from https://github.com/polkadot-js/apps/blob/41561e6cbf43ea8bf1cef86673155a1ca15c715b/packages/apps-config/src/ui/colors.ts
// the file cannot be imported from node_modules because it requires a webpack loader for image assets import
